    ...
    <div className="flex flex-col min-h-screen bg-slate-50/70">
      ...
      <header className="h-20 bg-white border-b border-slate-200 px-8 flex items-center justify-between shrink-0 shadow-2xs sticky top-0 z-10">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-3.5 py-2 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 rounded-lg text-xs font-semibold shadow-2xs transition-all flex items-center gap-2"
          >
                      ...
                      <tr key={campaign.id} className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="px-6 py-4 font-bold text-slate-800">
                          <span className="inline-flex items-center gap-1.5 bg-slate-100 px-2 py-0.5 rounded-md border border-slate-200">
                            <span>{getFlag(campaign.country)}</span>
      ...
      {showQuickGuide && (
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full p-6 shadow-2xl border border-slate-200 space-y-5 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div className="flex items-center gap-2.5 text-[#2b61d6]">
                <BookOpen className="w-5 h-5" />
                <h3 className="text-lg font-bold text-slate-900">HP QA Platform - Quick Operating Guide</h3>
              </div>
              <button
            ...
            <div className="space-y-4 text-xs text-slate-600 leading-relaxed max-h-[60vh] overflow-y-auto pr-1">
              <div className="p-3.5 bg-blue-50/60 rounded-xl border border-blue-100 space-y-1">
                <h4 className="font-bold text-slate-900 flex items-center gap-1.5 text-xs">
                  ...
                  1. Setup & Campaign Naming
                </h4>
                <p>Define country code, version name, and folder year. Campaign names are enforced to be unique to prevent collisions in SFMC.</p>
              </div>

              <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
                <h4 className="font-bold text-slate-900 text-xs">2. Upload Source Code or Design Files</h4>
                <p>Upload Outlook `.msg` / `.eml` files to automatically extract inline HTML and subject lines, or paste raw HTML and Figma design URLs.</p>
              </div>

              <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
                <h4 className="font-bold text-slate-900 text-xs">3. Automated Rules Engine</h4>
                <p>The platform runs automated checks for broken images, missing alt tags, unallowed URLs, tracking parameters, and mobile responsive layout.</p>
              </div>

              <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
                <h4 className="font-bold text-slate-900 text-xs">4. Folder & Drag-and-Drop Organization</h4>
                <p>Organize campaigns by year and quarterly subfolders. Drag and drop any campaign directly onto a folder in the sidebar to reassign it.</p>
              </div>
            </div>
            ...
            <div className="flex justify-end pt-3 border-t border-slate-100">
              <button
                type="button"
                onClick={() => setShowQuickGuide(false)}
                className="px-5 py-2 bg-[#2b61d6] hover:bg-indigo-700 text-white rounded-lg text-xs font-semibold shadow-xs"
              >
                Got it, close guide
              </button>
            </div>
